...
<div class="card mt-1">
	...
	<hr>	
        ...
        <div class="row">
			...
			<a href="https://suporte.matriza.com.br/cadastros/cadastro-de-fornecedores.html#importacao" target="_blank" title="Ajuda">
            ...
            <a href="{{ route('fornecedores.import-download') }}" class="btn btn-primary">
    ...
    <div class="card-footer">
        <hr>
        <form id="form-import" class="row" method="post" action="{{ route('fornecedores.import-store') }}" enctype="multipart/form-data">
            @csrf
            <p>Importar Modelo preenchido para importação dos dados
			
			<a href="https://suporte.matriza.com.br/cadastros/cadastro-de-fornecedores.html#upload" target="_blank" title="Ajuda">
				<i class="fa fa-question-circle" style="font-size: 20px; color: #629972;"></i>
			</a>	
