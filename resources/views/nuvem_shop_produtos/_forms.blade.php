			...
			<tbody>
				...
				<tr>
					<td style="min-width: 600px;">
						<select class="form-control produto" name="produto_vinculacao_id[]">
							<option value="-1">Digite para buscar o produto para vincular (opcional)</option>
						</select>

					</td>
					<td>
						<input readonly required style="width: 300px" type="" class="form-control" name="nome[]" value="{{ $p['nome'] }}">
					</td>
					<td>
						<input style="width: 150px" readonly type="" class="form-control" name="mercado_livre_status[]" value="{{ $p['status'] }}">
					</td>
					<td>
						<input style="width: 250px" readonly type="" class="form-control" name="nuvem_shop_id[]" value="{{ $p['nuvem_shop_id'] }}">
					</td>
					<td>
						<input required style="width: 200px" type="tel" class="form-control moeda" name="valor_venda[]" value="{{ __moeda((float)$p['valor_venda']) }}">
					</td>
					<td>
						<input required style="width: 200px" type="tel" class="form-control moeda" name="nuvem_shop_valor[]" value="{{ __moeda((float)$p['nuvem_shop_valor']) }}">
					</td>

					<td>
						<input required style="width: 120px" type="tel" class="form-control" name="estoque[]" value="{{ __moeda((float)$p['estoque']) }}" data-mask='00000.00' data-mask-reverse="true">
					</td>
					<td>
						<input style="width: 200px" type="tel" class="form-control moeda" name="valor_compra[]" value="">
					</td>
					<td>
						<input style="width: 200px" type="tel" class="form-control" name="codigo_barras[]" value="{{ ($p['codigo_barras']) }}">
					</td>
					<td>
						...
						<table class="table">
							...
							<tbody>
								...
								<tr>
									...
									<input type="hidden" name="nuvem_shop_id_row[]" value="{{ $p['nuvem_shop_id'] }}">
