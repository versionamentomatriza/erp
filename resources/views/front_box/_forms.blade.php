...
<style>
  ...
  overflow: hidden;
  background-image: url('/logopdv.png'); /* Define a imagem de fundo */
  background-position: center center;
  background-size: cover; /* Faz a imagem ocupar 100% do contêiner */
  background-repeat: no-repeat;
  opacity: 1; /* Opacidade total para a div */
}

.scrollspy-example {
  position: relative;
  z-index: 1; /* Mantém a tabela acima da imagem de fundo */
  background-color: rgba(255, 255, 255, 0.8); /* Define uma leve opacidade para destacar o conteúdo */
}
</style>
@endsection
...
<div class="row">
    <div class="col-lg-4">
        ...
        <div class="card" style="height: 750px">
            ...
            <div class="row">
                <div class="col-1 text-center">
                    <input class="mousetrap" type="" autofocus style="border: none; width: 10px; height: 10px; background-color:black" id="impressoraAutomatica" name="">
                </div>
