<tr class="dynamic-form">
    ...
    <td width="80">
        @if($mesmo_estado)
        <input value="{{ $prod->produto->cfop_entrada_estadual }}" class="form-control cfop" type="tel" name="cfop[]" id="inp-cfop_estadual">
        @else
        <input value="{{ $prod->produto->cfop_entrada_outro_estado }}" class="form-control cfop" type="tel" name="cfop[]" id="inp-cfop_estadual">
        @endif
    </td>
