...
<body>
    ...
    <tr>
        ...
        <td class="b-top text-left" style="width: 350px;">
            Vendedor: <strong>{{$item->funcionario->nome ?? 'Não informado'}}</strong>
        </td>
    </tr>
    </table>
        ...
        <tr>
            ...
            <td class="" style="width: 350px;">
                ...
                @if(!empty($item->responsavel))
                    <!-- Busca o funcionário pelo ID do responsável -->
                    @php
                        $responsavel = \App\Models\Funcionario::find($item->responsavel);
                    @endphp
                    <span style="font-size: 11px;">
                        {{ $responsavel ? $responsavel->nome : 'Responsável não encontrado' }}
                    </span>
                @elseif($item->tpNF == 1)
