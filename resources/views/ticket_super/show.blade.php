        ...
        <div class="row container">
            <div class="col-md-8">
                ...
                <div class="row">
                    ...
                    <form class="col-12" action="{{ route('ticket-super.destroy-mensagem', $m->id) }}" method="post" id="form-{{$m->id}}">
                        @method('delete')

                        @csrf
                        <button style="float: right;" type="button" class="btn btn-delete btn-sm btn-danger">
                ...
                @if($item->status != 'resolvido')
                <form class="row g-2" method="post" action="{{ route('ticket-super.add-mensagem', [$item->id]) }}" enctype="multipart/form-data">
                    @csrf
                    @method('put')
                    <div class="col-md-12">
                ...
                <div class="card" style="background: #F7F7F7">
                    <div class="card-body">
                        ...
                        <div class="row"> 
                            ...
                            <div class="col-md-7">
                                {!!Form::select('status', 'Status', ['aberto' => 'Aberto', 'respondida' => 'Respondida', 'aguardando' => 'Aguardando', 'resolvido' => 'Resolvido'])
                            ...
                            <div class="col-md-4">
                                <br>
                                <button type="submit" class="btn btn-success px-5" id="btn-store">Alterar</button>
