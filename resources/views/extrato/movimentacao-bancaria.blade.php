                    ...
                    <div class="card shadow-none border-0">
                        <div class="card-body">
                            ...
                            <div class="fs-5 fw-semibold">R$
                                {{ number_format($movimentacao['receita_liquida'], 2, ',', '.') }}</div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-end text-danger">R$
                                {{ number_format($movimentacao['deducao_receita'], 2, ',', '.') }}
                            </td>
                        ...
                        <tr>
                            ...
                            <td class="text-end text-danger">R$
                                {{ number_format($movimentacao['despesa_financeira'], 2, ',', '.') }}
                            </td>
                            <td class="text-end text-danger">
                        ...
                        <tr class="table-secondary">
                            ...
                            <td class="text-end fw-semibold">R$
                                {{ number_format($movimentacao['resultado_antes_ir'], 2, ',', '.') }}
                            </td>
                            <td class="text-end fw-semibold">
