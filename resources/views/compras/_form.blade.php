                            ...
                            <table class="table table-dynamic table-produtos" style="width: 2800px">
                                ...
                                <tbody>
                                    ...
                                    <tr class="dynamic-form">
                                        ...
                                        <td width="120">
                                            <input required value="{{ $prod->cfop }}" class="form-control cfop" type="tel" name="cfop[]" id="inp-cfop_estadual">
                                        </td>
                                    ...
                                    <tr class="dynamic-form">
                                        ...
                                        <td width="150">
                                            <input required class="form-control cfop" type="tel" name="cfop[]" id="inp-cfop_estadual">
                                        </td>
