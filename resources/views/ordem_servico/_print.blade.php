...
<div class="row corpo-exame" style="height: 550px;">
	...
	<div class="col s12 center-align">
		<h6 style="text-decoration: underline;"><strong id="nome-exame">IMAGENS</strong></h6>
	</div>
	<div class="col s12">
		@foreach($ordem->imagens as $img)
			<div class="col s6 center-align" style="margin-bottom: 25px;">
				<img src="{{ asset('storage/' . $img->arquivo) }}" alt="Imagem OS" style="max-width: 100%; max-height: 300px;">
				<p style="font-size: 0.9em; margin-top: 8px;">
					<strong>Enviado por:</strong> {{ $img->usuario->name ?? 'Usuário desconhecido' }}<br>
