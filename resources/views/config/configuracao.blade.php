...
<div class="">
    ...
    <div class="row">
        <div class="card">
            <div class="col-md-12 mt-3">
                <ul class="nav nav-tabs nav-primary" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                        <a class="nav-link" data-bs-toggle="tab" href="#informacoes" role="tab" aria-selected="false">
                            <div class="d-flex align-items-center">
                                <div class="tab-icon"><i class='fa fa-info-circle font-18 me-2'></i>
                                </div>
                                <div class="tab-title">
                                    Informações de Cadastro Inicial
                                </div>
                            </div>
                        </a>
                    </li>					
                ...
                <div class="tab-content py-3">
                            ...
                            <div class="row m-3">
                                <div class="col-md-4">
                                 ...
                                 <div class="col-md-3">
                                    ...
                                    ->attrs([
                                        ...
                                        'readonly',
                                        'onfocus' => 'this.blur()', // Impede o foco no campo
                                        'tabindex' => '-1',         // Impede navegar com o Tab
                                        'style' => 'pointer-events: none; background-color: #e9ecef;' // Impede clique e estiliza como desativado
                                    ])
                                    ->required()
                                    !!}
                                </div>
                                ...
                                <div class="col-md-3 mt-3">
									{!! Form::tel('celular', 'Telefone de atendimento')
										->attrs(['class' => 'fone', 'data-mask' => '(00) 00000-0000'])
									!!}
                                </div>
                    ...
                    <div class="tab-pane fade" id="certificado" role="tabpanel">
                        <div class="card m-3">
                            ...
                            <p class="m-3">Arquivo do certificado A1 (Formato .pfx ou .p12) 
						...
						<div class="card m-3">
							<div class="row m-2">
								<div class="col-md-6 mb-3">
									{!! Form::text('nome_contato', 'Nome')
										->attrs(['class' => 'form-control', 'required' => true, 'placeholder' => 'Nome'])
										->required()
									!!}
								</div>
					
                                <div class="col-md-6 mb-3">
                                    {!! Form::select('cargo_funcao', 'Qual seu cargo ou função?', [
                                    '' => 'Selecione',
                                    0 => 'Dono/Sócio Proprietário',
                                    1 => 'Diretor',
                                    2 => 'Gerente',
                                    3 => 'Coordenador/Supervisor',
                                    4 => 'Analista/Assistente',
                                    5 => 'Contador',
                                    6 => 'BPO/Consultor',
                                    7 => 'Outro'
                                    ])
							...
							<div class="row">
									<div class="col-md-6 mb-3">
										{!! Form::select('atividade', 'Qual a atividade da sua empresa?', [
											'' => 'Selecione',
											0 => 'Comércio',
											1 => 'Serviço',
											2 => 'Indústria',
									...
									<div class="col-md-6 mb-3">
										{!! Form::select('qtd_funcionarios', 'Qual o número de funcionário da sua empresa?', [
											'' => 'Selecione', 
											0 => '1-9',
											1 => '10-99',
											2 => '100-499',
        ...
        <!-- Botão de Link -->
        <a href="https://suporte.matriza.com.br/primeiros-passos/emitente.html" 
           class="btn btn-light" 
           target="_blank" 
           title="Ajuda">
            Ajuda
