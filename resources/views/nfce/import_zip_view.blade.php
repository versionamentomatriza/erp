...
<div class="card mt-1">
    ...
    <div class="card-footer">
        <hr>
        <form id="form-import" class="row" method="post" action="{{ route('nfce.import-zip-store-files') }}" enctype="multipart/form-data">
            @csrf
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 col-12">
                                    Número NFCe: <strong class="text-primary">{{ $d['numero_nfe'] }}</strong>
                                </div>
                            </div>
