...
<div class="card mt-3">
    ...
    <div class="row">
        ...
        <hr>
        <div class="m-3">
            <h5>Cliente: <strong class="text-primary"> {{ $item->cliente ? $item->cliente->razao_social : 'Consumidor Final' }}</strong></h5>
            <h6>CNPJ: <strong class="text-success">{{ $item->cliente ? $item->cliente->cpf_cnpj : '--' }}</strong></h6>
            ...
            @endif
            <h6>Chave NFCe: <strong class="text-success"> {{ $item->chave != "" ? $item->chave : '--' }}</strong></h6>
        </div>
        <hr>
        <div class="row m-3">
            <div class="col-md-3">
