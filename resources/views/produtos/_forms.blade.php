    ...
    <div class="tab-content b-0 mb-0">
        <div class="tab-pane" id="tab-identificacao">
            <div class="row g-2">
                ...
                <div class="col-md-2">
                    {!!Form::tel('peso', 'Peso do Produto (gramas)')
    ...
    <div class="tab-content b-0 mb-0">
        <div class="tab-pane" id="tab-fiscal">
            <div class="row g-2">
                ...
                <div class="col-md-6">    
                    {!!Form::select('cst_csosn', 'CST/CSOSN', App\Models\Produto::listaCSTCSOSN())
                    ->required(__isPlanoFiscal())
                    ->attrs(['class' => 'form-select'])
                    !!}
                </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body div-veiculos d-none m-card" style="margin-top: -40px">
                                <div class="row g-2">
                                    ...
                                    <div class="col-md-2">
                                        {!! Form::text('renavam', 'Renavam')->attrs(['data-mask' => '000000000000']) !!}
                                    </div>
                                    <div class="col-md-2">
