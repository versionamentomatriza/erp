...
<div class="mt-3">
    <div class="row">
        <div class="card">
            <div class="card-body">
                <div class="col-md-2">
                    <a href="{{ route('adicionais.create') }}" class="btn btn-success">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-md-3 text-left ">
                            ...
                            <a id="clear-filter" class="btn btn-danger" href="{{ route('adicionais.index') }}"><i class="ri-eraser-fill"></i>Limpar</a>
                        </div>
                    </div>
                    {!!Form::close()!!}
                </div>
