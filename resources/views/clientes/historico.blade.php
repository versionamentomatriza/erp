...
<div class="mt-3">
    <div class="row">
        <div class="card">
            <div class="card-body">
                <hr class="mt-3">
                <h5>Histórico do cliente: <strong class="text-primary">{{ $item->info }}</strong><a href="{{ !isset($isCliente) ? route('clientes.index') : route('clientes.index') }}" class="btn btn-danger btn-sm px-3 position-absolute" style="right: 15px; top: 8px; z-index: 1;"> <i class="ri-arrow-left-double-fill"></i>Voltar </a></h5>
