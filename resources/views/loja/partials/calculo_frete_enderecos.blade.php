<div class="container" style="margin-top: 15px">
	<label>{{ $endereco->info }}</label>
	@foreach($data as $item)
	<div class="col-12">
		<input class="radio-frete" type="radio" name="tipo_frete" id="radio" value="{{ $item['tipo'] }}" data-valor="{{ (float)$item['valor'] }}" data-endereco-id="{{ $endereco->id }}">
